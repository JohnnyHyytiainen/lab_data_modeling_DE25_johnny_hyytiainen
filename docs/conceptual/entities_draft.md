...
2) **UTBILDARE**   
(kan vara konsult ELLER fast anställd)  
...
- Ansvarig för 3 klasser(eller 3 program)
    - **Påpeka ambiguity i business reqs**
...
lön (vs konsults arvode per timme)  
